...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" type="text/css" media="screen" 
		href="/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
          ...
          <div class="">
            ...
            <div class="row">									<!-- PRIMER FORMULARIO -->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Nuevo Cargamento <small>Agregar</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="php/add_shipment.php" method="post">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha de Carga <span class="required">*</span>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<input id="pickup_date_val" name="pickup_date" class="datetime-picker form-control col-md-7 col-xs-12 avoidreadonlystyle" required="required" type="text" readonly />
					  ...
					  <div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Fecha de Entrega <span class="required">*</span>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<input id="drop_date_val" name="drop_date" class="date-picker form-control col-md-7 col-xs-12 avoidreadonlystyle" required="required" type="text" readonly />
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
							</div>
					  </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a type="reset" class="btn btn-primary" href="homeadmin.php">Cancel</a>
